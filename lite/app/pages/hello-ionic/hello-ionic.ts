...
export class HelloIonicPage {
  ...
  constructor(private navController: NavController) {
    ...
    this.slides = [
      ...
      {id: 6,  author: "-J. Rumi",       title: "Out beyond ideas of wrongdoing and right doing, there is a field. I͛'ll meet you there. "},
      ...
      {id: 8,  author: "-E. Tolle",      title: "What a liberation to realise that the voice in my head͛ is not who I am. Who am I then? The one who sees that."},
