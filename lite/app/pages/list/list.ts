...
export class ListPage {
  ...
  constructor(private navCtrl: NavController, navParams: NavParams) {
    ...
    this.subMenus = [
      ...
      { id: 90,  border_type: 1, parent_id: 43,  title: 'Three minute BMW',                                platform: ' ',  contain: 'none',   type: 'html', stage: 'empty', child_type: 3, time: '(3 mins)',    url: 'assets/explore/lets_go_deeper/tips_and_tools/module_meaningful_connection.html'},
